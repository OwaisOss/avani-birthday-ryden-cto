      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/50 p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="text-center mb-12">
            ...
            <div className="h-1 bg-linear-to-r from-transparent via-[#ff6b9d] to-transparent mx-auto max-w-xs rounded-full" />
          </div>

          {/* Letter content with modern styling */}
          <div className="space-y-8">
            <div className="text-2xl font-semibold text-[#c44569] font-[family-name:var(--font-playfair)]">
              Dear Avani,
            </div>

            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <div className="bg-linear-to-r from-[#ff6b9d]/10 to-[#c44569]/10 rounded-2xl p-6 border-l-4 border-[#ff6b9d]">
